...
// xdescribe('Adding Users to the database', () => {
...
//   it('Should resolve null when user exists on insert', async () => {
//     return await expect(db.addUser(SAMPLE_USER_1)).resolves.toBeNull();
//   });
// });

// xdescribe('Adding Books to the database', () => {
//   it('should always resolve the author when added', async () => {
//     await db_util.truncateAll();
...
//   it('should resolve undefined when invalid input', () => {});
// });

// xdescribe('Add book to user library', () => {
