...
//     | Column
//     | ColumnSet
//     | Array<string | TColumnConfig | Column>;
...
//     constructor(
//       columns: Array<string | TColumnConfig | Column>,
//       options?: TColumnSetOptions
//     );
...
//     extend(
//       columns: Column | ColumnSet | Array<string | TColumnConfig | Column>
//     ): ColumnSet;
...
//   export interface IDatabase<Ext> extends IBaseProtocol<Ext> {
...
//     stream(
//       qs: Object,
//       init: (stream: NodeJS.ReadableStream) => void
//     ): XPromise<{ processed: number; duration: number }>;
...
//       query: TQuery,
//       values: any,
//       cb: (row: any, index: number, data: any[]) => T,
//       thisArg?: any
//     ): XPromise<IArrayExt<T>>;

//     // API: http://vitaly-t.github.io/pg-promise/Database.html#each
//     each<T = any>(
//       query: TQuery,
//       values: any,
//       cb: (row: any, index: number, data: any[]) => void,
//       thisArg?: any
//     ): XPromise<IArrayExt<T>>;
...
//     format(
//       query: string | QueryFile | CTFObject,
//       values?: any,
//       options?: TFormattingOptions
//     ): string;
...
//     objectToCode(
//       obj: any,
//       cb?: (value: any, name: string, obj: any) => any
//     ): string;

//     enumSql(
//       dir: string,
//       options?: { recursive?: boolean; ignoreErrors?: boolean },
//       cb?: (file: string, name: string, path: string) => any
//     ): any;
...
// // API: http://vitaly-t.github.io/pg-promise/module-pg-promise.html
// declare function pgPromise(
//   options?: pgPromise.IOptions<IEmptyExt>
// ): pgPromise.IMain
// declare function pgPromise<Ext>(
//   options?: pgPromise.IOptions<Ext>
// ): pgPromise.IMain
